...
QUICK START
-------------------------------------------------------------
1. To get started, all you have to do is add the 'BehaviourTreeOwner' component on the gameobject you want to control.
2. Press 'Create New' in the inspector of that added component.
3. Select 'Bound' in the dialog box that will pop up.
4. The editor is now open. You can start creating your Behaviour Tree with right-click to add new nodes!
...
- Backup your project.
- Remove previous "ParadoxNotion/CanvasCore" and "ParadoxNotion/NodeCanvas Lite" folders.
