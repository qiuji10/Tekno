// Credits to: SG4YK from: https://github.com/SG4YK/DS4Motion_Unity
...
public class DS4
{
    ...
    public static Gamepad getConroller(string layoutFile = null)
    {
        ...
        string layout = File.ReadAllText(layoutFile == null ? "Assets/3_Scripts/DualShock Gyro/customLayout.json" : layoutFile);

        // Overwrite the default layout
        InputSystem.RegisterLayoutOverride(layout, "DualShock4GamepadHID_2");
